...
This library replicates Excel behavior. However, there're several differences comparing to the Excel version which should be taken into account. The details are provided below.
